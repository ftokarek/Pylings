...
assert f_string_message == "John Doe is 25 years old.", f"[FAIL] Expected 'John Doe is 25 years old.', got '{f_string_message}'"
assert format_message == "John Doe is 25 years old.", f"[FAIL] Expected 'John Doe is 25 years old.', got '{format_message}'"
